    ...
    return (
        <>
            <footer className="w-full bg-primary">
                <div className="w-screen max-w-450 flex flex-col py-6 md:py-12 lg:py-16 xl:py-16 px-8.5 md:px-12 lg:px-12 xl:px-38">
                    <div className={`flex flex-col ${openSans.className}`}>
                        <div className="flex flex-col text-neutral p-0">
                            ...
                            <div className="flex flex-row justify-between pt-4 md:pt-8 lg:pt-12 xl:pt-15">
                                <div className="flex flex-col gap-4">
                                    <div className="grid grid-cols-2 gap-y-0.5 md:gap-y-1.5 gap-x-4">
                                        <div className="flex flex-col gap-1 md:gap-2 xl:gap-3">
                                            ...
                                            <p className="text-[10px] md:text-sm xl:text-base font-normal xl:font-semibold">+234 8033611576</p>
                                        </div>
                                        ...
                                        <div className="flex flex-col gap-1 md:gap-2 xl:gap-3">
                                            <p className="text-[0.5rem] md:text-[10px] opacity-60 font-normal">Contact Us</p>
                                            <p className="text-[10px] md:text-sm xl:text-base font-normal xl:font-semibold">+234 8183213384</p>
                                        </div>
                                    </div>

                                    <div className="flex flex-col gap-1 md:gap-2 xl:gap-3">
                                        <p className="text-[0.5rem] md:text-[10px] opacity-60 font-normal">Email</p>
                                        <p className="text-[10px] md:text-sm xl:text-base font-normal xl:font-semibold">ubotexnigeria@yahoo.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col justify-end items-end gap-3.5 md:gap-8 xl:gap-11.5">
                                    ...
                                    <div className="flex flex-col gap-1 text-right">
                                        <p className="text-[10px] md:text-sm xl:text-base font-normal xl:font-semibold">IfaIkotOkpon Timber Market, Uyo,
                            ...
                            <div className="pt-9.5 md:pt-12 xl:pt-1">
                                <h1 className={"text-5xl md:text-6xl xl:text-[178px] text-center " + playfairDisplay.className}>UBOTEX NG</h1>
                            </div>
                        </div>
                    </div>
                </div>
