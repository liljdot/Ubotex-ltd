        ...
        <>
            <section className="flex flex-col gap-16 xl:gap-50">
                ...
                <div className="relative h-100 xl:h-175">
                    <div className={"hidden md:flex absolute -top-[10%] left-[5%] card bg-base-100 shadow-lg rounded-none z-1 " + openSans.className}>
                            ...
                            <ul className="flex flex-col md:gap-8 lg:gap-12 xl:gap-15 md:w-72 lg:w-80 xl:w-104">
                                <li className="flex flex-row gap-2 lg:gap-3 xl:gap-4">
                                    ...
                                    <span className="flex flex-col gap-2.5 text-base-content">
                                        ...
                                        <p className="text-xs">IfaIkotOkpon Timber Market, Uyo</p>
                                    </span>
                                </li>
                                ...
                                <li className="flex flex-row gap-2 lg:gap-3 xl:gap-4">
                                    ...
                                    <span className="flex flex-col gap-2.5 text-base-content">
                                        ...
                                        <div>
                                            <p className="text-xs">International calls : +234 701 189 7553</p>
                                            <p className="text-xs">National calls : +234 701 189 7553</p>
                                        </div>
                                    </span>
                                </li>
                                ...
                                <li className="flex flex-row gap-2 lg:gap-3 xl:gap-4">
                                    ...
                                    <span className="flex flex-col gap-2.5 text-base-content">
                                        ...
                                        <p className="text-xs">ubotexnigeria@yahoo.com</p>
                                    </span>
                                </li>
                            </ul>
                        </div>
