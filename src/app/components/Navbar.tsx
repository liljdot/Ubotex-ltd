                ...
                <div className="navbar-end min-w-fit">
                    <div className="dropdown dropdown-end md:hidden">
                        ...
                        >
                            ...
                            <li><a className="text-base p-0">Services</a></li>
                            <li><a className="text-base p-0">Projects</a></li>
                    ...
                    <ul className={`menu menu-horizontal gap-6 text-neutral px-1 hidden md:inline-flex ${openSans.className}`}>
                        ...
                        <li><a className="xl:text-lg p-0">Services</a></li>
                        <li><DomainLink subDomain="xowine" className="xl:text-lg p-0">Projects</DomainLink></li>
